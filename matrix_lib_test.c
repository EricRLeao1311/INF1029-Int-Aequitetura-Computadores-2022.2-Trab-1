...
int main(int argc, char *argv[]) {
  ...
  // matrix 1
  {
    ...
    matrix1.rows = (float *)malloc(sizeof(float) * height1 * width1);
    assert(matrix1.rows);
  }
  // matrix 2
  {
    ...
    matrix2.rows = (float *)malloc(sizeof(float) * height2 * width2);
    assert(matrix2.rows);
  }
  // matrix 3
  {
    ...
    matrix3.rows = (float *)malloc(sizeof(float) * height1 * width2);
    assert(matrix3.rows);
  }
  ...
  int matrixSize = matrix1.height * matrix2.width;
